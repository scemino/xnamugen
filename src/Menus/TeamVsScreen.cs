...
{
    internal class TeamVsScreen : SelectScreen
    {
        public TeamVsScreen(MenuSystem screensystem, TextSection textsection, string spritepath, string animationpath, string soundpath)
